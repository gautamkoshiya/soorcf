        ...
        <div class="container-fluid">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Customer Advance</li>
                        </ol>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Customer Advances</h2>
...
{{--                                        <th>Payment Type</th>--}}
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Customer Advance Detail</h5>
    ...
    <!-- Modal -->
    <!-- Modal -->
    <div class="modal fade" id="deleteCustomerAdvance" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
        ...
        $(document).ready(function () {
            $('#delete_payment_submit').click(function (event) {
                if (validateForm()) {
                    ...
                    $.ajax({
                        url: "{{ URL('customer_advance_delete_post') }}",
                        type: "post",
    ...
    <script>
        function show_detail(e)
        {
            ...
            if (id > 0)
            {
                ...
                $.ajax({
                    url: "{{ URL('getCustomerAdvanceDetail') }}/"+id,
                    type: "get",
                    dataType: "json",
                    success: function (result) {
        ...
        function push_payment(e)
        {
            ...
            if (id > 0)
            {
                ...
                $.ajax({
                    url: "{{ URL('customer_advances_push') }}/"+id,
                    type: "get",
                    dataType: "json",
                    success: function (result) {
                        location.reload();
    ...
    <script>
        function cancel_customer_advance(e)
        {
            if(ConfirmDelete())
            {
                var id=e;
                ...
                if (id > 0)
                {
                    ...
                    $.ajax({
                        url: "{{ URL('cancelCustomerAdvance') }}/"+id,
                        type: "get",
                        dataType: "json",
                        success: function (result) {
                            if (result === true)
