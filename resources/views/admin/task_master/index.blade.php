...
@section('title', 'Task Master List')
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        ...
                        <a href="{{ route('task_masters.create') }}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Task Master</h2>
                            <div class="table-responsive m-t-40">
                                <table id="task_master_table" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th>SR#</th>
                                        <th>Assigned By</th>
        ...
        $(document).ready(function () {
            $('#delete_row_submit').click(function (event) {
                if (validateForm()) {
                    ...
                    $.ajax({
                        url: "{{ URL('task_master_delete_post') }}",
                        type: "post",
                        data: {deleteDescription:deleteDescription,row_id:_row_id},
                        success: function (result) {
                            if (result === true) {
                                window.location.href = "{{ route('task_masters.index') }}";
                            } else {
    ...
    <script>
        $(document).ready(function () {
            $('#task_master_table').dataTable({
                processing: true,
                ServerSide: true,
                ajax:{
                    url: "{{ route('task_masters.index') }}",
                },
                columns:[
                    {
                        data: 'id',
