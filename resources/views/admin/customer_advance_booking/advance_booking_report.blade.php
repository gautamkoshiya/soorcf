...
@section('title', 'Advance Booking Report')
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Advance Booking Report</li>
                        </ol>
                       </div>
                </div>
            </div>

            <h3 class="card-title">Advance Booking Report</h3>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <a href="javascript:void(0)" onclick="return get_pdf()"><button id="submit" type="button" class="btn btn-info "><i class="fa fa-plus-circle"></i> Get Booking Report</button></a>
                    </div>
                </div>
            </div>
