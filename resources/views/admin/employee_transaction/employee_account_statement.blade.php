...
@section('title', 'Employee Account Statement')
...
@section('content')
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Employee Account Statement</li>
                        </ol>
                       </div>
                </div>
            </div>

            <h3 class="card-title">Employee Account Statement</h3>
    ...
    <script>
        function get_pdf()
        {
            ...
            $.ajax({
                url: "{{ URL('PrintEmployeeAccountStatement') }}",
                type: "POST",
                dataType : "json",
                data : {"_token": "{{ csrf_token() }}",fromDate:fromDate,toDate:toDate,employee_id:employee_id,employee_name:employee_name},
