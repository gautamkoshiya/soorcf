...
@section('title', 'Expense VAT Report')
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Expense VAT Report</li>
                        </ol>
                       </div>
                </div>
            </div>

            <h3 class="card-title">EXPENSE VAT REPORT</h3>
