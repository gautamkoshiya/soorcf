...
@section('title', 'Supplier Payable Summary')
...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Payable Summary</li>
                        </ol>
                       </div>
                </div>
            </div>
            ...
            <div class="row">
                <h2 class="card-title">Payable Summary</h2>
            </div>
            ...
            <h2>Payable Summary For Date </h2>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <a href="javascript:void(0)" onclick="return get_date_to_date_pdf()"><button id="submit_date" type="button" class="btn btn-info"><i class="fa fa-plus-circle"></i> Get Supplier Statement</button></a>
                    </div>
                </div>
            </div>
            {{--  date to date statement --}}
    ...
    <script>
        function get_date_to_date_pdf()
        {
            ...
            $.ajax({
                url: "{{ URL('PrintSupplierStatementForDate') }}",
                type: "POST",
                dataType : "json",
                data : {"_token": "{{ csrf_token() }}",toDate:toDate,},
                success: function (result) {
                    window.open(result.url,'_blank');
                    $('#submit_date').text('Get Supplier Statement');
