    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <a href="javascript:void(0)" onclick="return get_pdf()"><button id="submit" type="button" class="btn btn-info"><i class="fa fa-plus-circle"></i> Get Purchase Report</button></a>
                    </div>
                </div>
            </div>
        ...
        function get_pdf()
        {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $('#submit').text('Get Purchase Report');
