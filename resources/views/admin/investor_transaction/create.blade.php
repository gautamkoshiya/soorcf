...
@section('title', 'ADD Investor Transaction')
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-8 align-self-center">
                    <h2 class="text-themecolor">Investor Transaction</h2>
                ...
                <div class="col-md-4 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">New Investor Transaction</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="#">
                                <div class="form-body">
                                    <h3 class="card-title">ADD Investor Transaction</h3>
                                    <h6 class="required">* Fields are required please don't leave blank</h6>
                                    <h6 class="required">* Credit -> Transaction will increase(+) cash/bank for selected company</h6>
                                    <h6 class="required">* Debit -> Transaction will decrease(-) cash/bank for selected company</h6>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="control-label">Paid/Received By :- <span class="required">*</span> </label>
                                                <input type="text" id="PersonName" name="PersonName" class="form-control" placeholder="Enter Paid By Name" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function () {
            $('#already_exist').hide();
            $('#referenceNumber').submit(function () {
    ...
    <script>
        ...
        function validateForm()
        {
            ...
            if(DoTrim(document.getElementById('PersonName').value).length == 0)
            {
                if(fields != 1)
                {
        ...
        $(document).ready(function () {
            $('#submit').click(function (event) {
                if(validateForm()) {
                    ...
                    $.ajax({
                        url: "{{ route('investor_transactions.store') }}",
                        type: "post",
                        data: Datas,
                        success: function (result) {
                            if (result === true) {
                                alert("Record Inserted Successfully");
                                window.location.href = "{{ route('investor_transactions.index') }}";
                            } else {
                                window.location.href = "{{ route('investor_transactions.index') }}";
                            }
                        },
