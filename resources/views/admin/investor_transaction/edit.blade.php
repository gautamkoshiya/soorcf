                            ...
                            <form action="#">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control amount" onClick="this.setSelectionRange(0, this.value.length)" value="{{ $payment_receive->paidAmount }}" name="" id="paidAmount" placeholder="Paid Amount" autocomplete="off">
                                            </div>
                                        </div>
