...
@section('title', 'Investor Transactions List')
...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <a href="{{ URL('InvestorReportByCompany') }}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Get Report</button></a>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                            <li class="breadcrumb-item active">Investor Transactions</li>
                        </ol>
                        <a href="{{ route('investor_transactions.create') }}"><button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</button></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title">Investor Transactions</h2>
                            <h5 class="required">** EDIT IS NOT ALLOWED SO VERIFY ENTRY BEFORE SAVE **</h5>
                            <div class="table-responsive m-t-40">
                                <table id="investor_transaction_table" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th>SR#</th>
                                        <th>Investor</th>
        ...
        $(document).ready(function () {
            $('#delete_row_submit').click(function (event) {
                if (validateForm()) {
                    ...
                    $.ajax({
                        url: "{{ URL('investor_transaction_delete_post') }}",
                        type: "post",
    ...
    <script>
        $(document).ready(function () {
            $('#investor_transaction_table').dataTable({
                processing: true,
                ServerSide: true,
                ajax:{
                    url: "{{ route('investor_transactions.index') }}",
                },
                columns:[
                    {
                        data: 'id',
