...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h2 class="text-themecolor">Quotation</h2>
        </div>
                    ...
                    <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select project_id select2 chosen-select" name="project_id" id="project_id" required>
                                        ...
                                        @foreach($projects as $project)
                                            <option value="{{ $project->id }}" {{ ($project->id == $quotation->project->id) ? 'selected':'' }}>{{ $project->Name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control QuotationNumber" name="QuotationNumber" id="QuotationNumber" value="{{ $quotation->QuotationNumber }}" readonly>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">From date :- <span class="required">*</span></label>
                                            <input type="date" name="FromDate" id="FromDate" class="form-control" value="{{ $quotation->FromDate}}" placeholder="dd/mm/yyyy">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Due date :- <span class="required">*</span></label>
                                            <input type="date" name="DueDate" id="DueDate" class="form-control" value="{{ $quotation->DueDate}}" placeholder="dd/mm/yyyy">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <textarea name="TermsAndCondition" id="TermsAndCondition" cols="30" rows="5" class="form-control" style="width: 100%" placeholder="Terms And Condition">{{ $quotation->TermsAndCondition }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label>Customer Note :- </label>
                                        <div class="form-group">
                                            <textarea name="CustomerNote" id="CustomerNote" cols="30" rows="5" class="form-control" style="width: 100%" placeholder="Customer Note">{{ $quotation->CustomerNote }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            <select name="IsNeedStampOrSignature" class="form-control IsNeedStampOrSignature" id="IsNeedStampOrSignature">
                                                <option value="0" {{ ($quotation->IsNeedStampOrSignature == 0) ? 'selected':'' }}>No</option>
                                                <option value="1" {{ ($quotation->IsNeedStampOrSignature == 1) ? 'selected':'' }}>YES</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <p>Discount(AED): <input type="number" value="{{$quotation->discount}}" class="form-control discount">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="{{ route('quotations.index') }}" class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
