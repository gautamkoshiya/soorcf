...
@section('title', 'Inward Loan Payment')
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">InwardLoan Payment</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">InwardLoan Payment</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="m-b-0 text-white">InwardLoan Payment</h4>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ url('inward_loan_save_payment',$inward_loan->id) }}" enctype="multipart/form-data" id="customer_create" onsubmit="return validateForm();">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               ...
                                               <input type="text" readonly value="{{$inward_loan->financer->Name}}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="totalAmount" class="form-control" readonly value="{{$inward_loan->inward_RemainingBalance}}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
