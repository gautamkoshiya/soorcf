...
@section('title', 'Report File Type Create')
        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">Report File Type</h4>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h4 class="m-b-0 text-white">Report File Type</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('report_file_types.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
