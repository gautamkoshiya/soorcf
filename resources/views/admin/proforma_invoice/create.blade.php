                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control PFINVNumber" name="PFINVNumber" id="PFINVNumber" value="{{ $PFINVNumber }}" readonly>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
        ...
        $('#submit').click(function () {
            if(validateForm() && validateAllRows())
            {
                ...
                if (insert.length > 0)
                {
                    ...
                    $.ajax({
                        url: "{{ route('proforma_invoices.store') }}",
                        type: "post",
                        data: Datas,
                        success: function (result) {
                            ...
                            if (result.result === true) {
                                ...
                                window.location.href = "{{ route('proforma_invoices.create') }}";
                            }
                        },
