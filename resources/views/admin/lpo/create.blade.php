                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control LPONumber" name="LPONumber" id="LPONumber" value="{{ $LPONumber }}" readonly>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (result.result === true) {
                                ...
                                window.location.href = "{{ route('lpos.create') }}";
                            }
                        },
