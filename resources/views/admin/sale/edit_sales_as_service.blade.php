...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="#">
                                <div class="form-body">
                                    <input type="hidden" name="sale_id" id="sale_id" value="{{ $sales->id }}">
                                    <div class="row p-t-20">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Customer :- <span class="required">*</span></label>
                                                <select class="form-control custom-select customer_id select2 chosen-select" name="customer_id" id="customer_id" required disabled>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control PadNumber" name="PadNumber" id="PadNumber" autocomplete="off" value="{{ $sale_details[0]->PadNumber }}" readonly>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="SaleDate" id="SaleDate" class="form-control" value="{{ $sales->SaleDate }}" placeholder="dd/mm/yyyy">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table color-bordered-table success-bordered-table" style="overflow: hidden;z-index: 999;height:350px;" id="scroll_table">
                                            ...
                                            @foreach($sale_details as $details)
                                                @if(is_null($details->deleted_at))
                                                    <tr>
                                                        ...
                                                        <td><input type="number" placeholder="Quantity" class="quantity form-control" id="cur_qty" value="{{ $details->Quantity }}" autocomplete="off" min="0">
                                                        ...
                                                        <td><input type="number" placeholder="Price" id="Price" class="price form-control" autocomplete="off" value="{{ $details->Price }}" min="0"></td>
                                                        <td>
                                                            <div class="form-group">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="number" placeholder="VAT"  id="VAT" class="VAT form-control" value="{{ $details->VAT }}" min="0">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" placeholder="Quantity" class="quantity form-control" id="cur_qty" value="0" autocomplete="off" min="0">
                                                    <input type="hidden" placeholder="Total" class="total form-control">
                                                    <input type="hidden" placeholder="Single Row Vat" value="0.00" class="singleRowVat form-control">
                                                </td>

                                                <td><input type="number" placeholder="Price" id="Price" value="0" class="price form-control" autocomplete="off" min="0"></td>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input type="number" placeholder="VAT" value="0" id="VAT" class="VAT form-control" min="0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <p style="display: none;">Discount(AED): <input type="number" value="0.00" class="form-control discount" min="0">
                                        </div>
                                        <div class="col-md-2">
            ...
            $(document).on("click",'.addRow', function () {
                ...
                if(validateRow(currentRow))
                {
                    ...
                    var discount = currentRow.find('.discount').val();
                    {
                        ...
                        html += '<td><input type="number" min="0" placeholder="Quantity" value="0" class="quantity form-control"><input type="hidden" placeholder="Total" class="total form-control"><input type="hidden" placeholder="Total discount" class="totalD form-control"><input type="hidden" placeholder="singleItemVat" class="singleItemVat form-control"></td>';
                        ...
                        html += '<td><input type="number" min="0" id="VAT" value="0" class="VAT form-control"><input type="hidden" class="hidden_vat" value="0"></td>';
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#newRow tr').each(function () {
                if ($(this).find(".rowTotal").val().trim() !== ""){
                    final_subtotal = parseFloat(final_subtotal) + parseFloat($(this).find(".rowTotal").val());
                }
                if ($(this).find(".rowTotal").val().trim() !== ""){
                    final_vat = parseFloat(final_vat) + parseFloat($(this).find(".hidden_vat").val());
                }
