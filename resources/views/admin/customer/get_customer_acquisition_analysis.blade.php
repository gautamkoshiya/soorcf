...
@section('title', 'Customer Acquisition Analysis')
...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            ...
            <h2 class="card-title">Customer Acquisition Analysis</h2>
            <h6 class="required">* Fields are required please don't leave blank</h6>
            <form action="{{ URL('ViewCustomerAcquisitionAnalysis') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-3">
